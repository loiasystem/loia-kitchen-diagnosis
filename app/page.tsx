...
type DiagnosisResult = {
  ...
  flavorExpansionNarrative: string;
      ...
      return Object.fromEntries(
        Object.entries(result.scores).map(
          ([key, value]) => [
            ...
            Math.max(
              22,
              Math.round(Math.sqrt(Number(value) / 120) * 100)
            )
          ]
        )
      );
      ...
      <section className="mx-auto flex min-h-screen max-w-5xl flex-col px-6 pt-8 pb-52">
        ...
        {!result ? (
          <>
            ...
            <div className="mx-auto max-w-2xl">
              <section className="rounded-3xl border border-[#ded5c8] bg-white/70/70 p-6 shadow-2xl">
                <h2 className="mb-4 text-xl font-medium">사진 업로드</h2>
                <div className="mb-5">
          ...
          <section className="mx-auto max-w-5xl rounded-3xl border border-[#ded5c8] bg-white/70 p-6 shadow-2xl">
            <h2 className="mb-4 text-xl font-medium">진단 결과</h2>
            ...
            <div className="max-w-3xl space-y-3">
              ...
              <p className="text-base leading-7 text-[#7a746b]">
                {result.flavorSubtitle}
              </p>
            </div>
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-2xl bg-[#f8f4ec] p-5">
                <p className="mb-3 text-sm text-[#5f574d]">Flavor Profile</p>
                <p className="leading-8 text-[#1f1a14] whitespace-pre-line">
                  {result.flavorNarrative}
                </p>
              </div>

              <div className="rounded-2xl bg-[#f8f4ec] p-5">
                <p className="mb-3 text-sm text-[#5f574d]">Flavor Expansion / 새로운 맛 세계 제안</p>
                <p className="leading-8 text-[#1f1a14] whitespace-pre-line">
                  {result.flavorExpansionNarrative}
                </p>
              </div>
            </div>
          </section>
